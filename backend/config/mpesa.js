...
export const MPESA_CONFIG = {
  // Real M-Pesa Daraja API Credentials (sandbox environment)
  // NOTE: Replace these with your actual credentials from https://developer.safaricom.co.ke/
  ...
  // Passkey for STK Push (from M-Pesa portal)
  ...
  TIMEOUT_URL: process.env.MPESA_TIMEOUT_URL || 'https://yourdomain.com/api/payments/mpesa/timeout',
